...
legacy_router = APIRouter(tags=["node-types"])
...
@legacy_router.get("/node-types", response_model=StandardResponse)
...
@legacy_router.get("/core-nodes", response_model=StandardResponse)
...
@legacy_router.get("/plugins", response_model=StandardResponse)
...
@legacy_router.get("/node-types/{node_id}", response_model=StandardResponse)
